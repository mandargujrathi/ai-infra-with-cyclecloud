...
Azure CycleCloud Workspace for Slurm will be used in the AI Infra Landing Zone. To deploy the AI Infra landing zone accelerator we can use the Azure Marketplace or the Azure CLI. The following resources in your Azure subscription as shown in the architecture below: \
